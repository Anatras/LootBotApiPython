...
setup(
  ...
  packages = ['C:\\Users\\uni\\Desktop\\Api Loot'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/Anatras/LootBotApiPython/archive/v_01.tar.gz',    # I explain this later on
